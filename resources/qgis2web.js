...
map.getView().fit([936952.373100, 7848010.335460, 1146186.930110, 7961991.359475], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Initiatives of Managed Retreat in Europe</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (144 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Here we present a dataset of European managed retreat cases, based on a multilingual review of academic and grey literature, and media articles.';
            }
